...
| [spec-0065](spec-0065-furniture-is-not-floor.md) | Furniture is not floor — a piece declares its furniture as a named place, and the walk model never proves a body onto it | Proposed |
