...
| [spec-0067](spec-0067-every-slot-the-game-has.md) | Every slot the game has — the equipment block names the pinned game's eight slots, and a piece is refused where the game would not show it | Proposed |
