...
| [spec-0069](spec-0069-a-showcase-camera-placed-by-hand.md) | A showcase camera placed by hand — when no agent-chosen render camera satisfies, a person places it in the running game and exactly that camera reaches the Chunky render | Proposed |
